...
},{}],2:[function(require,module,exports){void function(root){
    var boxes = require('../')
        , tape = require('tape')
        , fs = require('fs')
        , tpl = "#test\n    %p= @content\n"
...
},{"fs":1,"../":3,"tape":4}],5:[function(require,module,exports){// shim for using process in browser
...
},{}],4:[function(require,module,exports){(function(process){var createDefaultStream = require('./lib/default_stream');
...
},{"./lib/default_stream":6,"./lib/render":7,"./lib/test":8,"__browserify_process":5}],6:[function(require,module,exports){var Stream = require('stream');
...
},{"stream":9}],9:[function(require,module,exports){var events = require('events');
...
},{"events":10,"util":11}],10:[function(require,module,exports){(function(process){if (!process.EventEmitter) process.EventEmitter = function () {};
...
},{"__browserify_process":5}],12:[function(require,module,exports){(function(process){function filter (xs, fn) {
    var res = [];
    for (var i = 0; i < xs.length; i++) {
...
},{"__browserify_process":5}],11:[function(require,module,exports){var events = require('events');
...
},{"events":10}],13:[function(require,module,exports){void function(root){
...
},{}],3:[function(require,module,exports){void function(root){
...
},{"viral":13,"haml-coffee":14}],7:[function(require,module,exports){var Stream = require('stream');
...
},{"stream":9,"jsonify":15}],8:[function(require,module,exports){(function(process,__dirname){var EventEmitter = require('events').EventEmitter;
...
},{"events":10,"path":12,"deep-equal":16,"defined":17,"__browserify_process":5}],16:[function(require,module,exports){var pSlice = Array.prototype.slice;
...
},{}],17:[function(require,module,exports){module.exports = function () {
    for (var i = 0; i < arguments.length; i++) {
        if (arguments[i] !== undefined) return arguments[i];
    }
};

},{}],15:[function(require,module,exports){exports.parse = require('./lib/parse');
exports.stringify = require('./lib/stringify');

},{"./lib/parse":18,"./lib/stringify":19}],18:[function(require,module,exports){var at, // The index of the current character
...
},{}],19:[function(require,module,exports){var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
