...
},{}],2:[function(require,module,exports){// shim for using process in browser
...
},{}],3:[function(require,module,exports){(function(process){var createDefaultStream = require('./lib/default_stream');
...
},{"./lib/default_stream":4,"./lib/render":5,"./lib/test":6,"__browserify_process":2}],4:[function(require,module,exports){var Stream = require('stream');
...
},{"stream":7}],7:[function(require,module,exports){var events = require('events');
...
},{"events":8,"util":9}],8:[function(require,module,exports){(function(process){if (!process.EventEmitter) process.EventEmitter = function () {};
...
},{"__browserify_process":2}],10:[function(require,module,exports){(function(process){function filter (xs, fn) {
    var res = [];
    for (var i = 0; i < xs.length; i++) {
